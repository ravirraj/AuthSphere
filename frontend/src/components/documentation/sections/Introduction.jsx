    ...
    <article className="space-y-12 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        <div className="flex-1 space-y-4">
          <Badge
            variant="outline"
            className="w-fit border-primary/20 bg-primary/5 text-primary text-[10px] py-0 h-5 px-2"
          >
            v1.0.4 / core_specification
          </Badge>
          <h1 className="text-4xl font-extrabold tracking-tight text-foreground">
            Identity Infrastructure{" "}
            <span className="text-primary text-glow-sm">for Modern Apps</span>
          </h1>
          <p className="text-base text-muted-foreground leading-relaxed max-w-3xl">
            AuthSphere is a high-performance, developer-first identity engine
            designed to solve the complexities of modern authentication. By
            providing an abstraction layer over complex protocols like OIDC,
            OAuth 2.0, and PKCE, AuthSphere allows you to implement secure,
            scalable authentication in minutes while maintaining complete
            control over your user data and session logic.
          </p>
        ...
        <div className="w-full lg:w-72 shrink-0 p-4 rounded-2xl border bg-card/50 backdrop-blur-sm space-y-4 shadow-sm">
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-muted-foreground">
              Core technical specifications of the identity engine.
            </p>
          </div>
          <div className="space-y-2">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between p-2 rounded-lg bg-muted/30 border border-transparent hover:border-primary/10 transition-colors"
              >
      ...
      <div className="space-y-6">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            The platform architecture is built on four primary pillars of
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <Card
              key={i}
              className="bg-card/30 hover:bg-card/80 transition-all border-muted shadow-none group relative overflow-hidden"
            >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-3">
              <p className="text-sm text-muted-foreground leading-relaxed">
                Unlike traditional identity providers that store passwords with
                simple hashes, AuthSphere utilizes a{" "}
                <strong>Multi-Layer Memory Hard Algorithm</strong>. Every user
                password is processed through Argon2id with 50MB of memory
                parallelization, making it resilient against GPU-accelerated
                brute force attacks.
              </p>
            ...
            >
              {[
                ...
                <TypingAnimation
                  key={idx}
                  className={`text-[10px] ${line.startsWith("#") ? "text-emerald-400" : line.startsWith("$") ? "text-blue-400" : "text-zinc-500"}`}
                >
                  {line || " "}
                </TypingAnimation>
              ))}
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Deliver a seamless, branded authentication experience across every
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="space-y-3 p-6 rounded-2xl border bg-card/30">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Inject your logo, primary brand colors, and custom footer text
              into every system email. No more generic, third-party styled
              notifications.
            </p>
          </div>
          <div className="space-y-3 p-6 rounded-2xl border bg-card/30">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Give users confidence with technical context. Optionally include
              IP addresses, device types, and geographical locations in
              verification emails.
            </p>
          </div>
          <div className="space-y-3 p-6 rounded-2xl border bg-card/30">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Use the integrated **Deliverability Tester** to send live
              rendering previews to your inbox before deploying changes to
              production.
            </p>
          </div>
        </div>
